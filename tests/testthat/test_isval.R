...
test_that("works as expected", {
  ...
  expect_equal( isval(data.frame() ), FALSE )
  ...
  expect_equal( isval( data.frame(v1=character(),v2=numeric()) ) , TRUE ) # in the past this has incorrectly categorized an empty data frame as null.
